...
var extract = {
  ...
  multipoint: function multipoint(_multipoint) {
    ...
    for (var i = 0, len = _multipoint._geometries.length; i < len; ++i) {
      array.push('(' + extract.point.apply(this, [_multipoint._geometries[i]]) + ')');
    }
    return array.join(',');
  },
  ...
  linestring: function linestring(_linestring) {
    ...
    for (var i = 0, len = _linestring._points._coordinates.length; i < len; ++i) {
      array.push(extract.coordinate.apply(this, [_linestring._points._coordinates[i]]));
    }
    return array.join(',');
  },
  linearring: function linearring(_linearring) {
    ...
    for (var i = 0, len = _linearring._points._coordinates.length; i < len; ++i) {
      array.push(extract.coordinate.apply(this, [_linearring._points._coordinates[i]]));
    }
    return array.join(',');
  },
  ...
  multilinestring: function multilinestring(_multilinestring) {
    ...
    for (var i = 0, len = _multilinestring._geometries.length; i < len; ++i) {
      array.push('(' + extract.linestring.apply(this, [_multilinestring._geometries[i]]) + ')');
    }
    return array.join(',');
  },
  ...
  polygon: function polygon(_polygon) {
    var array = [];
    array.push('(' + extract.linestring.apply(this, [_polygon._shell]) + ')');
    for (var i = 0, len = _polygon._holes.length; i < len; ++i) {
      array.push('(' + extract.linestring.apply(this, [_polygon._holes[i]]) + ')');
    }
    return array.join(',');
  },
  ...
  multipolygon: function multipolygon(_multipolygon) {
    ...
    for (var i = 0, len = _multipolygon._geometries.length; i < len; ++i) {
      array.push('(' + extract.polygon.apply(this, [_multipolygon._geometries[i]]) + ')');
    }
    return array.join(',');
  },
...
var extract$1 = {
  ...
  Polygon: function Polygon(polygon) {
    var array = [];
    var shellGeoJson = extract$1.LineString.apply(this, [polygon._shell]);
...
exports.CoordinateList = CoordinateList;
...
exports.IntersectionMatrix = IntersectionMatrix;
exports.PrecisionModel = PrecisionModel;
exports.Centroid = Centroid;
exports.CGAlgorithms = CGAlgorithms;
exports.ConvexHull = ConvexHull;
exports.InteriorPointArea = InteriorPointArea;
exports.InteriorPointLine = InteriorPointLine;
exports.InteriorPointPoint = InteriorPointPoint;
exports.RobustLineIntersector = RobustLineIntersector;
exports.MCPointInRing = MCPointInRing;
exports.MinimumBoundingCircle = MinimumBoundingCircle;
exports.MinimumDiameter = MinimumDiameter;
exports.Densifier = Densifier;
exports.LineDissolver = LineDissolver;
exports.GeometryGraph = GeometryGraph;
exports.quadtree = quadtree;
exports.strtree = strtree;
exports.GeoJSONReader = GeoJSONReader;
exports.GeoJSONWriter = GeoJSONWriter;
exports.OL3Parser = OL3Parser;
exports.WKTReader = WKTReader;
exports.WKTWriter = WKTWriter;
exports.BoundaryOp = BoundaryOp;
exports.IsSimpleOp = IsSimpleOp;
exports.BufferOp = BufferOp;
exports.BufferParameters = BufferParameters;
exports.DistanceOp = DistanceOp;
exports.LineMerger = LineMerger;
exports.OverlayOp = OverlayOp;
exports.Polygonizer = Polygonizer;
exports.RelateOp = RelateOp;
exports.CascadedPolygonUnion = CascadedPolygonUnion;
exports.PointGeometryUnion = PointGeometryUnion;
exports.UnaryUnionOp = UnaryUnionOp;
exports.UnionInteracting = UnionInteracting;
exports.UnionOp = UnionOp;
exports.IsValidOp = IsValidOp;
exports.ConsistentAreaTester = ConsistentAreaTester;
exports.GeometryPrecisionReducer = GeometryPrecisionReducer;
exports.DouglasPeuckerSimplifier = DouglasPeuckerSimplifier;
exports.TopologyPreservingSimplifier = TopologyPreservingSimplifier;
exports.ConformingDelaunayTriangulationBuilder = ConformingDelaunayTriangulationBuilder;
exports.DelaunayTriangulationBuilder = DelaunayTriangulationBuilder;
exports.VoronoiDiagramBuilder = VoronoiDiagramBuilder;
exports.quadedge = quadedge;
exports.LengthIndexedLine = LengthIndexedLine;
exports.LengthLocationMap = LengthLocationMap;
exports.LinearGeometryBuilder = LinearGeometryBuilder;
exports.LinearIterator = LinearIterator;
exports.LinearLocation = LinearLocation;
exports.LocationIndexedLine = LocationIndexedLine;
