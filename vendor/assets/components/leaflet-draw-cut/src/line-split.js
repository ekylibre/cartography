 ...
 */
window.bboxLineSplit = function(line, splitter) {
    ...
    case 'Polygon':
    case 'MultiPolygon':
        return bboxSplitLineWithPoints(line, lineIntersect(line, truncatedSplitter));
    }
}
 ...
 * @returns {FeatureCollection<LineString>} split LineStrings
 */
function bboxSplitLineWithPoints(line, splitter) {
    var results = [];
    var tree = rbush();
